...
#include "Datasets/Input/DataAsset_InputConfig.h"
...
public:
	...
	template<class UserObject, typename CallbackFunc>
	void BindAbilityInputAction(const UDataAsset_InputConfig* InInputConfig, UserObject* ContextObject, CallbackFunc Func, CallbackFunc InputReleasedFunc);
};
