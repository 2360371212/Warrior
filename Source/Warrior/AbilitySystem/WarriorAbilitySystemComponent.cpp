...
// check the Ability has been given.
...
void UWarriorAbilitySystemComponent::RemoveGrantedHeroWeaponAbility(UPARAM(ref)TArray<FGameplayAbilitySpecHandle>& InSpecHandlesToRemove)
{
